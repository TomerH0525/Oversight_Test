...
const CartItem = React.memo((props: DefaultTransaction) => {
  ...
  return (
    <div className="flex flex-row flex-shrink-0 gap-2 md:p-2 w-[95%] border-b mx-auto mt-2">
      <Card className="flex flex-row h-[125px] grow border-0 shadow-none rounded-none gap-2">
        <CardHeader className="lg:w-[140px] p-0 my-auto ">
        ...
        <CardContent className="flex flex-col gap-2 text-center m-auto w-[95%] p-0">
          ...
          <CardDescription className="line-clamp-2">{props.itemDescription}</CardDescription>
        </CardContent>
      </Card>
